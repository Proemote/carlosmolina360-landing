...
const oldTimeline = `      tl.to(bgRef.current, { backgroundColor: '#141414', duration: 1 }, 0)
...
fs.writeFileSync('src/components/Cierre.tsx', originalCode.replace(oldTimeline, newTimeline));
