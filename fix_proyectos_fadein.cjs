    ...
    <section ref={sectionRef} className="py-24 md:py-40 overflow-hidden text-grafito">
      <div ref={contentRef} className="max-w-6xl mx-auto px-6 opacity-0">
        ...
        <div className="mb-16 md:mb-24 flex flex-col items-center text-center">
          ...
          <p className="text-2xl md:text-3xl text-gray-500 font-medium tracking-tight mb-8">
        ...
        <div className="relative w-full left-1/2 -translate-x-1/2 w-screen py-4">
          <div className="flex justify-center items-center gap-4 md:gap-8 px-4 md:px-0">
            {/* Left Card */}
            <div className="hidden md:flex flex-col w-[300px] lg:w-[400px] shrink-0 opacity-40 hover:opacity-100 transition-opacity cursor-pointer group">
            ...
            {/* Center Card */}
            <div className="flex flex-col w-[90vw] md:w-[500px] lg:w-[600px] shrink-0 z-10 cursor-pointer group">
