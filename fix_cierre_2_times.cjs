const fs = require('fs');
const originalCode = fs.readFileSync('src/components/Cierre.tsx', 'utf-8');
  ...
  return (
    <section ref={containerRef} className="w-full h-screen relative overflow-hidden text-blanco bg-grafito">
      ...
      <div className="absolute inset-0 flex items-center justify-center">
        ...
        {/* Block 3: Por eso escribo... (normal) */}
        <div ref={text3Ref} className="absolute w-full max-w-4xl px-6 opacity-0 flex flex-col items-center text-center">
          <div className="text-2xl md:text-4xl text-gray-300 font-light leading-relaxed mb-16 space-y-4">
            <p>Por eso escribo.</p>
            <p>Mentorizo.</p>
          ...
          <p className="text-3xl md:text-5xl text-gray-300 font-serif italic">
            Porque cada uno de ellos forma parte de una misma idea.
          </p>
        </div>

        {/* Block 4: Por eso escribo... (with green) */}
        <div ref={text4Ref} className="absolute w-full max-w-4xl px-6 opacity-0 flex flex-col items-center text-center">
          <div className="text-2xl md:text-4xl text-gray-300 font-light leading-relaxed mb-16 space-y-4">
            <p>Por eso escribo.</p>
            <p>Mentorizo.</p>
            <p>Desarrollo empresas.</p>
